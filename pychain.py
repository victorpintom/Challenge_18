...
# YOUR CODE HERE
who_is_sending = st.text_input("Sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
who_is_receiving = st.text_input("Receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
what_amount = st.text_input("Amount")
...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        record=Record(who_is_sending, who_is_receiving, what_amount),
        creator_id=42,
